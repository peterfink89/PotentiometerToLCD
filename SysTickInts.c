...
uint32_t wait_per;
uint32_t ADC_Check = 0;                                //Checks for new value from ADC
uint32_t Status = 0;                                   //Mailbox status
#define HEART     (*((volatile uint8_t *) 0x40004C02)) //Port 1 HeartBeat Output
